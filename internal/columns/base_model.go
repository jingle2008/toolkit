...
var BaseModelColumns = Set[models.BaseModel]{Columns: []Column[models.BaseModel]{
	...
	{Title: "Display Name", Key: "display-name", Default: true, Ratio: 0.20,
	...
	{Title: "DAC Shape", Key: "dac-shape", Default: true, Ratio: 0.10,
		Render: func(m models.BaseModel) string { return baseModelDacShape(m) }},
	{Title: "Size", Key: "size", Default: true, Ratio: 0.05,
		Render: func(m models.BaseModel) string { return m.ParameterSize }},
	{Title: "Context", Key: "context", Default: true, Ratio: 0.05,
